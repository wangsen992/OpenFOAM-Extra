...
void Foam::DropletNucleationPhaseChangePhaseSystem<BasePhaseSystem>::addDmdts
(
...
template<class BasePhaseSystem>
Foam::DropletNucleationPhaseChangePhaseSystem<BasePhaseSystem>::
...
Foam::DropletNucleationPhaseChangePhaseSystem<BasePhaseSystem>::saturation
(
...
Foam::DropletNucleationPhaseChangePhaseSystem<BasePhaseSystem>::dmdtf
(
    const phasePairKey& key
) const
{
...
Foam::DropletNucleationPhaseChangePhaseSystem<BasePhaseSystem>::dmdts() const
{
...
template<class BasePhaseSystem>
Foam::PtrList<Foam::volScalarField>
Foam::DropletNucleationPhaseChangePhaseSystem<BasePhaseSystem>::d2mdtdps() const
{
...
Foam::DropletNucleationPhaseChangePhaseSystem<BasePhaseSystem>::heatTransfer() const
{
...
Foam::DropletNucleationPhaseChangePhaseSystem<BasePhaseSystem>::specieTransfer() const
{
...
template<class BasePhaseSystem>
void Foam::DropletNucleationPhaseChangePhaseSystem<BasePhaseSystem>::
...
template<class BasePhaseSystem>
void
Foam::DropletNucleationPhaseChangePhaseSystem<BasePhaseSystem>::correctInterfaceThermo()
{
...
template<class BasePhaseSystem>
bool Foam::DropletNucleationPhaseChangePhaseSystem<BasePhaseSystem>::read()
{
