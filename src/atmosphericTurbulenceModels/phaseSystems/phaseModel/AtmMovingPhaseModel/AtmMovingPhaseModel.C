...
Foam::AtmMovingPhaseModel<BasePhaseModel>::phi(const volVectorField& U) const
{
...
template<class BasePhaseModel>
Foam::AtmMovingPhaseModel<BasePhaseModel>::AtmMovingPhaseModel
(
...
template<class BasePhaseModel>
void Foam::AtmMovingPhaseModel<BasePhaseModel>::correctContinuityError
(
...
template<class BasePhaseModel>
void Foam::AtmMovingPhaseModel<BasePhaseModel>::correct()
{
...
template<class BasePhaseModel>
void Foam::AtmMovingPhaseModel<BasePhaseModel>::correctKinematics()
{
...
template<class BasePhaseModel>
void Foam::AtmMovingPhaseModel<BasePhaseModel>::correctTurbulence()
{
...
template<class BasePhaseModel>
void Foam::AtmMovingPhaseModel<BasePhaseModel>::correctEnergyTransport()
{
...
template<class BasePhaseModel>
void Foam::AtmMovingPhaseModel<BasePhaseModel>::correctUf()
{
...
template<class BasePhaseModel>
bool Foam::AtmMovingPhaseModel<BasePhaseModel>::stationary() const
{
    return false;
}
...
Foam::AtmMovingPhaseModel<BasePhaseModel>::UEqn()
{
...
template<class BasePhaseModel>
Foam::tmp<Foam::fvVectorMatrix>
Foam::AtmMovingPhaseModel<BasePhaseModel>::UfEqn()
{
...
Foam::AtmMovingPhaseModel<BasePhaseModel>::U() const
{
    return U_;
}
...
template<class BasePhaseModel>
Foam::volVectorField&
Foam::AtmMovingPhaseModel<BasePhaseModel>::URef()
{
    return U_;
}
...
template<class BasePhaseModel>
Foam::tmp<Foam::surfaceScalarField>
Foam::AtmMovingPhaseModel<BasePhaseModel>::phi() const
{
    return phi_;
}
...
Foam::AtmMovingPhaseModel<BasePhaseModel>::phiRef()
{
    return phi_;
}
...
Foam::AtmMovingPhaseModel<BasePhaseModel>::Uf() const
{
    return
        Uf_.valid()
...
Foam::AtmMovingPhaseModel<BasePhaseModel>::UfRef()
{
    if (Uf_.valid())
    {
        return Uf_.ref();
...
template<class BasePhaseModel>
Foam::tmp<Foam::surfaceScalarField>
Foam::AtmMovingPhaseModel<BasePhaseModel>::alphaPhi() const
{
    return alphaPhi_;
}
...
template<class BasePhaseModel>
Foam::surfaceScalarField&
Foam::AtmMovingPhaseModel<BasePhaseModel>::alphaPhiRef()
{
    return alphaPhi_;
}
...
template<class BasePhaseModel>
Foam::tmp<Foam::surfaceScalarField>
Foam::AtmMovingPhaseModel<BasePhaseModel>::alphaRhoPhi() const
{
    return alphaRhoPhi_;
}
...
template<class BasePhaseModel>
Foam::surfaceScalarField&
Foam::AtmMovingPhaseModel<BasePhaseModel>::alphaRhoPhiRef()
{
    return alphaRhoPhi_;
}
...
template<class BasePhaseModel>
Foam::tmp<Foam::volVectorField>
Foam::AtmMovingPhaseModel<BasePhaseModel>::DUDt() const
{
    if (!DUDt_.valid())
    {
...
template<class BasePhaseModel>
Foam::tmp<Foam::surfaceScalarField>
Foam::AtmMovingPhaseModel<BasePhaseModel>::DUDtf() const
{
    if (!DUDtf_.valid())
    {
...
Foam::AtmMovingPhaseModel<BasePhaseModel>::continuityError() const
{
...
template<class BasePhaseModel>
Foam::tmp<Foam::volScalarField>
Foam::AtmMovingPhaseModel<BasePhaseModel>::K() const
{
    if (!K_.valid())
    {
...
template<class BasePhaseModel>
Foam::tmp<Foam::volScalarField>
Foam::AtmMovingPhaseModel<BasePhaseModel>::divU() const
{
...
template<class BasePhaseModel>
void Foam::AtmMovingPhaseModel<BasePhaseModel>::divU(tmp<volScalarField> divU)
{
    divU_ = divU;
}
...
template<class BasePhaseModel>
Foam::tmp<Foam::volScalarField>
Foam::AtmMovingPhaseModel<BasePhaseModel>::pPrime() const
{
...
Foam::AtmMovingPhaseModel<BasePhaseModel>::kappaEff(const label patchi) const
{
...
Foam::AtmMovingPhaseModel<BasePhaseModel>::divq(volScalarField& he) const
{
...
template<class BasePhaseModel>
Foam::tmp<Foam::fvScalarMatrix>
Foam::AtmMovingPhaseModel<BasePhaseModel>::divj(volScalarField& Yi) const
{
