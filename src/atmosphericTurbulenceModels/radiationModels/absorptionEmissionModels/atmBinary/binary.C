...
Foam::atmRadiationModels::absorptionEmissionModels::binary::binary
(
...
Foam::atmRadiationModels::absorptionEmissionModels::binary::aCont
(
    const label bandI
) const
{
...
Foam::tmp<Foam::volScalarField>
Foam::atmRadiationModels::absorptionEmissionModels::binary::aDisp
(
    const label bandI
) const
{
...
Foam::tmp<Foam::volScalarField>
Foam::atmRadiationModels::absorptionEmissionModels::binary::eCont
(
    const label bandI
) const
{
...
Foam::tmp<Foam::volScalarField>
Foam::atmRadiationModels::absorptionEmissionModels::binary::eDisp
(
    const label bandI
) const
{
