...
{
    defineTypeNameAndDebug(atmFvDOM, 0);
    addToRadiationRunTimeSelectionTables(atmFvDOM);
}
}
...
void Foam::radiationModels::atmFvDOM::initialise()
{
...
Foam::radiationModels::atmFvDOM::atmFvDOM(const volScalarField& T)
:
...
Foam::radiationModels::atmFvDOM::atmFvDOM
(
...
bool Foam::radiationModels::atmFvDOM::read()
{
...
void Foam::radiationModels::atmFvDOM::calculate()
{
...
Foam::tmp<Foam::volScalarField> Foam::radiationModels::atmFvDOM::Rp() const
{
...
Foam::radiationModels::atmFvDOM::Ru() const
{
...
void Foam::radiationModels::atmFvDOM::updateBlackBodyEmission()
{
    for (label j=0; j < nLambda_; j++)
    {
...
void Foam::radiationModels::atmFvDOM::updateG()
{
...
void Foam::radiationModels::atmFvDOM::setRayIdLambdaId
(
    const word& name,
    label& rayId,
    label& lambdaId
