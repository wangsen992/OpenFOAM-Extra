...
#include "atmRadiativeIntensityRay.H"
#include "fvm.H"
#include "fvDOM.H"
#include "constants.H"
...
const Foam::word Foam::radiationModels::atmRadiativeIntensityRay::intensityPrefix
(
    "ILambda"
);
...
Foam::radiationModels::atmRadiativeIntensityRay::atmRadiativeIntensityRay
(
    const fvDOM& dom,
    const fvMesh& mesh,
    const scalar phi,
...
Foam::scalar Foam::radiationModels::atmRadiativeIntensityRay::correct()
{
...
void Foam::radiationModels::atmRadiativeIntensityRay::addIntensity()
{
